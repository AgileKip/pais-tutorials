    ...
    <div class="col-10">
      <div v-if="travelPlanProcess.processInstance">
        <h2 class="jh-entity-heading" data-cy="travelPlanProcessDetailsHeading">
          <span v-text="$t('travelPlanProcessApp.travelPlanProcess.detail.title')">TravelPlanProcess</span> {{ travelPlanProcess.id }}
        </h2>
            ...
            <div class="card" v-if="travelPlanProcess.travelPlan">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.name')">name</label>
                  <input
                    readonly
                    type="text"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.startDate')">startDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control form-control-sm"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.endDate')">endDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control form-control-sm"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.hotelName')">hotelName</label>
                  <input
                    readonly
                    type="text"
                    class="form-control form-control-sm"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.hotelBookingNumber')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.airlineCompanyName')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.airlineTicketNumber')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.carCompanyName')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanProcessApp.travelPlanProcess.carBookingNumber')"
