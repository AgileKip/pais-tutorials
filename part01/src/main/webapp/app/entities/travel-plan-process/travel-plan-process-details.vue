    ...
    <div class="col-10">
      <div v-if="travelPlanProcess.processInstance">
        <h2 class="jh-entity-heading" data-cy="travelPlanProcessDetailsHeading">
          <span v-text="$t('travelPlanTutorialApp.travelPlanProcess.detail.title')">TravelPlanProcess</span> {{ travelPlanProcess.id }}
        </h2>
            ...
            <div class="card" v-if="travelPlanProcess.travelPlan">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.name')">name</label>
                  <input
                    readonly
                    type="text"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.startDate')">startDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control form-control-sm"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.endDate')">endDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control form-control-sm"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.hotelName')">hotelName</label>
                  <input
                    readonly
                    type="text"
                    class="form-control form-control-sm"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.hotelBookingNumber')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.airlineCompanyName')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.airlineTicketNumber')"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.carCompanyName')"
                    >carCompanyName</label
                  >
                  <input
                    readonly
                    type="text"
              ...
              <div class="card-body">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelPlanTutorialApp.travelPlanProcess.carBookingNumber')"
