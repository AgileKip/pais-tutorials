      ...
      <div class="xcontainer">
        <div class="row px-3">
            ...
            <slot name="details">
              <div class="form-group">
                <label
                  ...
                  v-text="$t('travelPlanTutorialApp.processInstance.businessKey')"
          ...
          <div class="col summary">
            <div class="label" v-text="$t('travelPlanTutorialApp.processInstance.status')">Status</div>
            ...
            <hr />
            <div class="label" v-text="$t('travelPlanTutorialApp.processInstance.processDefinition')">Process Definition</div>
            ...
            <hr />
            <div class="label" v-text="$t('travelPlanTutorialApp.processInstance.camundaProcessInstanceId')">
            ...
            <hr />
            <div class="label" v-text="$t('travelPlanTutorialApp.processInstance.camundaProcessDefinitionId')">
            ...
            <div class="link" v-if="processInstance.processDefinition">
              <hr />
              <div class="label" v-text="$t('travelPlanTutorialApp.processDefinition.bpmnProcessDefinitionId')">
